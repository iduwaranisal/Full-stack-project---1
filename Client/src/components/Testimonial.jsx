...
const cardsData = [
  {
    ...
    handle: '@kasun_j',
    comment: 'Rented a Toyota Axio for 5 days. The vehicle was in top condition and very clean. The airport pickup was right on time.',
  },
  {
    image: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=200',
    name: 'Dilshan Madushanka',
    handle: '@dilshan_m',
    comment: 'Best rates in Colombo. I booked a WagonR for a week and it was very fuel efficient. No hidden charges at all.',
  },
  {
    image: 'https://images.unsplash.com/photo-1527980965255-d3b416303d12?w=200&auto=format&fit=crop&q=60',
    name: 'Chamara Perera',
    handle: '@chamara_p',
    comment: 'Excellent service. We hired a KDH van for a family trip to Nuwara Eliya. The driver was very safe and polite.',
  },
  {
    image: 'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=200&auto=format&fit=crop&q=60',
    name: 'Nuwan Pradeep',
    handle: '@nuwan_rides',
    comment: 'Seamless booking process via the website. The car was exactly as shown in the photos. Will definitely rent again.',
  },
];

// Sub-component for individual cards
const CreateCard = ({ card }) => (
  <div className="m-5 p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0 border border-gray-100 bg-white">
  ...
  return (
    <div className="py-10 bg-slate-50">
      ...
      <div className="marquee-row w-full mx-auto max-w-6xl overflow-hidden relative">
        <div className="absolute left-0 top-0 h-full w-20 z-10 pointer-events-none bg-gradient-to-r from-slate-50 to-transparent"></div>
        <div className="marquee-inner marquee-reverse flex transform-gpu min-w-max">
          {[...cardsData, ...cardsData].map((card, index) => (
